...
export const customTaskAsExercise = (task) => ({
  ...
  materialNecesario: task?.materialNecesario || '',
  tiempo: task?.tiempo || '',
  tiempoDescanso: Number(task?.tiempoDescanso) || 0,
  dimensiones: task?.dimensiones || '',
  numeroJugadores: Number(task?.numeroJugadores) || 0,
