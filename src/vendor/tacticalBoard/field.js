...
const DEFAULT_PLAYER_NUMBER_COLOR = '#ffffff';
...
const getDefaultBoardSettings = () => ({
  playerIcon1: { color: '#2176ff', size: DEFAULT_PLAYER_ICON_SIZE, shape: 'circle', hasStripes: false, stripeColor: '#ffffff', numberColor: DEFAULT_PLAYER_NUMBER_COLOR },
  playerIcon2: { color: '#ff3838', size: DEFAULT_PLAYER_ICON_SIZE, shape: 'circle', hasStripes: false, stripeColor: '#ffffff', numberColor: DEFAULT_PLAYER_NUMBER_COLOR },
  playerIcon3: { color: '#ffa600', size: DEFAULT_PLAYER_ICON_SIZE, shape: 'circle', hasStripes: false, stripeColor: '#ffffff', numberColor: DEFAULT_PLAYER_NUMBER_COLOR },
...
const mergeIconSettings = (defaults, fallback, settings) => ({
  ...defaults,
  ...(fallback || {}),
  ...(settings || {}),
...
const normalizeBoardSettings = (settings = {}, fallback = {}) => {
  settings = settings || {};
  fallback = fallback || {};
  ...
  return {
    ...
    ...fallback,
    ...settings,
    playerIcon1: mergeIconSettings(defaults.playerIcon1, fallback.playerIcon1, settings.playerIcon1),
    playerIcon2: mergeIconSettings(defaults.playerIcon2, fallback.playerIcon2, settings.playerIcon2),
    playerIcon3: mergeIconSettings(defaults.playerIcon3, fallback.playerIcon3, settings.playerIcon3),
    goalkeeperIcon1: mergeIconSettings(defaults.goalkeeperIcon1, fallback.goalkeeperIcon1, settings.goalkeeperIcon1),
    goalkeeperIcon2: mergeIconSettings(defaults.goalkeeperIcon2, fallback.goalkeeperIcon2, settings.goalkeeperIcon2),
    playerIcon4: {
      ...mergeIconSettings(defaults.playerIcon4, fallback.playerIcon4, settings.playerIcon4),
      hasBib: true,
    },
    teamPlayers: mergeIconSettings(defaults.teamPlayers, fallback.teamPlayers, settings.teamPlayers),
  };
};
                  ...
                  <View style={{ flex: 1 }}>
                    ...
                    <TouchableOpacity
                      style={[
                        ...
                        { backgroundColor: lineColor, width: '100%', height: 40 },
                      ]}
...
function SettingsPanel({
  ...
  const buildSettingsFromInputs = () => {
    ...
    const newSettings = normalizeBoardSettings({
      ...draftSettings,
      playerIcon1: { ...draftSettings.playerIcon1, size: validSize },
      playerIcon2: { ...draftSettings.playerIcon2, size: validSize },
      playerIcon3: { ...draftSettings.playerIcon3, size: validSize },
      goalkeeperIcon1: { ...draftSettings.goalkeeperIcon1, size: validSize },
      goalkeeperIcon2: { ...draftSettings.goalkeeperIcon2, size: validSize },
      playerIcon4: { ...draftSettings.playerIcon4, size: validSize, hasBib: true },
      teamPlayers: { ...draftSettings.teamPlayers, size: validSize },
    });
  ...
  const getNumberColor = (key) => {
    if (key === 'playerIcon4') return draftSettings?.playerIcon4?.numberColor || NEUTRAL_PLAYER_COLORS.letter;
        ...
        <View style={styles.proModalOverlay}>
          ...
          >
              ...
              <View style={styles.proModalSection}>
                ...
                <View style={styles.proModalCard}>
                  ...
                  <View style={styles.proModalRow}>
                    ...
                    />
                    <Text style={styles.proModalHint}>{t('tacticalBoard.editPanel.colorLabel')}</Text>
                  </View>
                  <View style={styles.proModalRow}>
                    {renderNumberColorControl('playerIcon1')}
                  </View>
                ...
                <View style={styles.proModalCard}>
                  ...
                  <View style={styles.proModalRow}>
                    {renderNumberColorControl('playerIcon2')}
                  </View>
                ...
                */}
                ...
                <View style={styles.proModalCard}>
                  ...
                  <View style={styles.proModalRow}>
                    {renderNumberColorControl('teamPlayers')}
                  </View>
                  <View style={[styles.proModalSwitch, { marginTop: 8 }]}>
                    <Text style={styles.proModalSwitchLabel}>
            ...
            <MiniColorPickerModal
              ...
              initialColor={numberColorPickerTarget ? getNumberColor(numberColorPickerTarget) : '#ffffff'}
              onClose={() => setNumberColorPickerTarget(null)}
              onSelect={(c) =>
                numberColorPickerTarget &&
                updateBoardIcon(numberColorPickerTarget, { numberColor: c })
              }
            />
            <MiniColorPickerModal
        ...
        <View style={styles.proModalOverlay}>
          ...
          >
            ...
            <View style={[styles.proModalHeader, { paddingVertical: 8, paddingHorizontal: 10 }]}>
              ...
              <TouchableOpacity
                style={[styles.proModalCloseBtn, { width: 28, height: 28 }]}
                onPress={onClose}
              >
                <Text style={{ fontSize: 14, color: '#666' }}>✕</Text>
              </TouchableOpacity>
            ...
            {(hideApplyToPalette || icon?.isMaterialPalette) && (
              <View style={{ paddingHorizontal: 14, paddingBottom: 8 }}>
                <Text
                  style={[
                    styles.proModalHint,
                    { color: '#2176ff', fontStyle: 'normal', fontWeight: '500' },
                  ]}
                >
                ...
                <>
                  ...
                  >
                    ...
                    <Text
                      style={[
                        isMobile ? styles.proModalLabelMobile : styles.proModalLabel,
                        { marginLeft: 6, color: '#2176ff', fontWeight: '600' },
                      ]}
                    >
...
function LockedElementsPanel({ visible, onClose, lockedElements, onUnlock, scale = 1 }) {
  const { t } = useTranslation();
  const dimensions = useScreenDimensions();
  const SCREEN_WIDTH = dimensions?.width || Dimensions.get('window').width;
  const SCREEN_HEIGHT = dimensions?.height || Dimensions.get('window').height;
      ...
      <View style={{ flex: 1 }}>
        <View
          style={[
            ...
            isMobile ? { padding: mobileModalMargin } : { alignItems: 'flex-end' },
          ]}
        >
          <Pressable style={StyleSheet.absoluteFill} onPress={onClose} />
          <View
          ...
          >
            ...
            >
              ...
              {showSettings && (
                <View
                  style={[
                    styles.proModalCard,
                    { margin: isMobile ? 0 : 12, marginTop: isMobile ? 10 : 12, marginBottom: 8 },
                  ]}
                >
                  ...
                  <View style={[styles.proModalGrid, { marginBottom: 12 }]}>
                    <TouchableOpacity
                      onPress={() =>
                        setFormationSettings &&
                        setFormationSettings((prev) => ({ ...prev, displayMode: 'number' }))
                      }
                      style={[
                        styles.proModalGridItem,
                        { flex: 1 },
                    ...
                    <TouchableOpacity
                      onPress={() =>
                        setFormationSettings &&
                        setFormationSettings((prev) => ({ ...prev, displayMode: 'position' }))
                      }
                      style={[
                        styles.proModalGridItem,
                        { flex: 1 },
                  ...
                  {displayMode === 'position' && (
                    <View>
                      <Text
                        style={{ fontSize: isMobile ? 11 : 12, color: '#666', marginBottom: 6 }}
                      >
                      ...
                      <ScrollView style={{ maxHeight: 150 }} nestedScrollEnabled>
                        <View style={{ flexDirection: 'row', flexWrap: 'wrap' }}>
                          {POSITION_TYPES.map((pos) => (
                            <View
                              key={pos}
                              style={{ width: '33%', paddingHorizontal: 2, marginBottom: 6 }}
                            >
                              <Text style={{ fontSize: isMobile ? 9 : 10, color: '#888' }}>
                    ...
                    <TouchableOpacity
                      ...
                      onPress={() => {
                        setSelectedSize((s) => {
                          ...
                          setTeamPlayerStyle &&
                            setTeamPlayerStyle((prev) => ({ ...prev, size: parseInt(newSize) }));
                          return newSize;
                        });
                      }}
                    >
            ...
            <View style={styles.proModalFooter}>
              <TouchableOpacity
                ...
                style={[
                  styles.proModalBtn,
                  { backgroundColor: '#dc3545', flex: 1, marginRight: 8 },
                ]}
              >
            ...
            <MiniColorPickerModal
              ...
              onClose={() => setNumberColorPickerVisible(false)}
              onSelect={(c) =>
                setTeamPlayerStyle && setTeamPlayerStyle((prev) => ({ ...prev, numberColor: c }))
              }
            />
            ...
            <MiniColorPickerModal
              ...
              onSelect={(c) =>
                setTeamPlayerStyle && setTeamPlayerStyle((prev) => ({ ...prev, textColor: c }))
              }
            />
            ...
            <MiniColorPickerModal
              ...
              onSelect={(c) =>
                setTeamPlayerStyle &&
                setTeamPlayerStyle((prev) => ({ ...prev, textBackgroundColor: c }))
              }
            />
                  ...
                  >
                    <View>
                      ...
                      <Text style={{ color: 'rgba(255,255,255,0.8)', fontSize: 12, marginTop: 2 }}>
                        {t('formations.selectedCount', { count: selectedPlayers.length })}/
                        {selectedPlayerCount}
                      </Text>
                    </View>
                          ...
                          >
                            ...
                            >
                              {teamPlayerStyle?.showPhotos && player.foto ? (
                                ...
                                <Text
                                  style={{ color: numberColor, fontWeight: 'bold', fontSize: 14 }}
                                >
                                  {player.dorsal || '?'}
                                </Text>
                              )}
...
function findTopBoardCloneAtPoint(
  clones,
  pointX,
  pointY,
  viewMode,
...
function applyBoardDragSnapshot(clone, snapshot, dxRatio, dyRatio, dxDisplay, dyDisplay) {
  ...
  if (snapshot.points) {
    return {
      ...clone,
      points: snapshot.points.map((point) => ({ x: point.x + dxRatio, y: point.y + dyRatio })),
    };
  }
  ...
  ({
    ...
    const handleResponderMove = (e) => {
      ...
      pendingUpdateRef.current = (prev) => {
        ...
        next[correctIndex] = {
          ...next[correctIndex],
          points: base.points.map((pt) => ({ x: pt.x + dx, y: pt.y + dy })),
        };
        return next;
      };
      if (!rafRef.current) {
    ...
    const handleResponderMove = (e) => {
      ...
      if (base.multiSelect && base.selectedIds && base.initialPositions) {
        ...
        pendingUpdateRef.current = (prev) => {
          ...
          next[idx] = {
            ...next[idx],
            points: base.points.map((pt) => ({ x: pt.x + ddx, y: pt.y + ddy })),
          };
          return next;
        };
      }
...
export default function Field(props = {}) {
            ...
            prev.map((icon) => {
              if (icon.id === 'icon1') {
                ...
                return {
                  ...icon,
                  ...playerSettings,
                  numberColor: playerSettings.numberColor ?? icon.numberColor ?? DEFAULT_PLAYER_NUMBER_COLOR,
  ...
  const clearHistory = useCallback(() => {
    ...
    const initialState = JSON.stringify({
      clones: actualClonesRef.current,
  ...
  function renderCustomShape({ icon, imageWidth, imageHeight }) {
    ...
    const pathData =
      pts.map((pt, i) => (i === 0 ? `M${pt.x},${pt.y}` : `L${pt.x},${pt.y}`)).join(' ') + ' Z';

    // Determinar el color de relleno con transparencia
    const fillColor =
      icon.fillColor && icon.fillColor !== 'transparent'
    ...
    if (fillColor !== 'transparent') {
      customShapeElements.push(
        <Path key={`fill-custom-shape-${icon.id}`} d={pathData} stroke="none" fill={fillColor} />,
      );
    }

    // L�nea principal (con o sin punteado)
    const customShapeStrokeDasharray =
  ...
  const handleSelectionMove = useCallback(
    (e) => {
      if (!multiSelectMode || selectionInteractionMode !== 'select' || !selectionStartRef.current)
        return;
      ...
      .filter((clone) => {
        ...
        if (clone.type === 'circle' && clone.points && clone.points.length === 2) {
          const pts = clone.points.map((p) => {
            if (p.x <= 1 && p.y <= 1)
              return ratioToDisplay(p.x, p.y, viewMode, imageWidth, imageHeight);
            return { x: p.x, y: p.y };
          });
      ...
      .filter((clone) => {
        return (
          (clone.type === 'straight-line' ||
            ...
            clone.type === 'curve-line' ||
            clone.type === 'curve-arrow' ||
            (clone.type === 'custom-shape' && clone.isCustomShapeComplete)) &&
          isCloneVisible(clone)
        );
      })
      .map((clone) => {
                  ...
                  <View style={styles.playersGrid}>
                    {availablePlayers.map((player, index) => (
                      ...
                      >
                        ...
                        <Text
                          style={[styles.playerGridName, { fontSize: nameFontSize }]}
                          numberOfLines={2}
                          ellipsizeMode="tail"
                        >
                          {getPlayerFullName(player) ||
            ...
            {lockedCount > 0 && (
              <View
                style={[
                  ...
                  isMobile && { width: 16, height: 16, borderRadius: 8, top: -2, right: -2 },
                ]}
              >
                <Text style={[styles.floatingButtonBadgeText, isMobile && { fontSize: 8 }]}>
                  {lockedCount}
                </Text>
              </View>
            )}
          ...
          >
            ...
            >
              <TouchableOpacity
                ...
                style={{ alignItems: 'center', marginBottom: isMobile ? 6 : 8 }}
              >
              ...
              <TouchableOpacity
                ...
                style={{ alignItems: 'center', marginBottom: isMobile ? 4 : 6 }}
              >
        ...
        >
          <ScrollView
            ...
            contentContainerStyle={[
              ...
              { paddingVertical: isMobile ? 4 : 12, paddingHorizontal: isMobile ? 8 : 20 },
            ]}
          >
            {sortedPlayers.length === 0 ? (
      ...
      return (
        ...
        >
          <ScrollView
            ...
            contentContainerStyle={[
              styles.slidingPaletteContent,
              { paddingVertical: isMobile ? 3 : 12, paddingHorizontal: isMobile ? 8 : 20 },
            ]}
          >
