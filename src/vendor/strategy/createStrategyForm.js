  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <Text style={styles.title} numberOfLines={1}>{editingStrategy ? (isSetPiece ? t('setPieces.edit') : t('strategy.editStrategy')) : (isSetPiece ? t('setPieces.create') : t('strategy.createStrategy'))}</Text>
      </LinearGradient>
      ...
      >
        ...
        <View style={styles.formCard}>
          ...
          <Text style={styles.inputLabel}>{isSetPiece ? t('setPieces.name') : t('strategy.name')}</Text>
          <TextInput
            style={styles.input}
